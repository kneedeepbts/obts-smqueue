...
/* Functions */
//enum kneedeepbts::smqueue::sm_state handle_sms_message(short_msg_pending *qmsg);

//bool check_to_user(char *user);

//char * read_short_msg_from_file(char *file);
...
char * SMqueue::new_strdup(const char *orig)
{
	int len = strlen(orig);
...
//void increase_acked_msg_timeout(short_msg_pending *msg) {
