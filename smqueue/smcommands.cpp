...
namespace kneedeepbts::smqueue {
    // FIXME: Are these "debug" commands needed?
///* Seekrit SMS message to make the server quit for valgrind leak checking. */
//    short_code_action whiplash_quit(const char *imsi, const char *msgtext, short_code_params *scp) {
//        //const char *psswd = gConfig.getStr("SC.WhiplashQuit.Password").c_str();
//        const char *psswd = "SC.WhiplashQuit.Password";
...
//                scp->scp_smq->save_queue_to_file(
//                        gConfig.getStr("SC.WhiplashQuit.SaveFile").c_str());  // Save on whiplash_quit
...
// */
//    enum short_code_action
//    shortcode_four_one_one(const char *imsi, const char *msgtext, short_code_params *scp) {
//        ostringstream answer;
//
