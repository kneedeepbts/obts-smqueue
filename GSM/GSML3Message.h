...
namespace kneedeepbts::gsm {
    ...
    class L3ReadError : public GSM::GSMError {
    public:
        L3ReadError() : GSMError() {}
    };
    //#define L3_READ_ERROR {throw L3ReadError();}

    class L3WriteError : public GSM::GSMError {
    public:
    ...
    */
    class L3Message {
        ...
        */
        virtual void parse(const GSM::L3Frame& source);
        ...
        */
        L3Frame* frame(Primitive prim=DATA) const;
